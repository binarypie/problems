...
# Return longest common subsequence given two substrings
def find_lcs(string_1, string_2):
	...
	lcs = []
	'''
	At this point we should have a matrix filled out with lcs lengths.
	The longest length will be on the bottom right cell.
	We will traceback from there and build our lcs.
	'''
